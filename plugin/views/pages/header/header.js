;V.registPlugin("v.views.pages.header",function(){
	V.Classes.create({
		className:"v.views.pages.Header",
		superClass:"v.Plugin",
		init:function(){
		    this.ns = "v.views.pages.header";
			this.resource = {
			    html:'template.html'
			}
		}
	...
	(function(Header){
		...
		Header.prototype.initEvent = function(){
		    var that = this;
			$(".upgrade",this.template).click(function(){
				var html = "";
				...
				dlg.setBtnsBar({btns:[
      			    ...
      			    ,{text:that.getLang("BIN_CLOSE"),style:"btn-primary",handler:dlg.close}
      			]});
      			dlg.init({width:560,height:280,title:'升级为主体'});
      			dlg.setContent(html);
			});
...
//				userName=userName+"("+CONSTANT.SFH_USER[LoginInfo.user.businessRole]+")";
...
//			})
	...
	})(V.Classes['v.views.pages.Header']);
},{plugins:['v.ui.alert','v.ui.confirm','v.ui.messageBox',"v.fn.validator",'v.ui.mask']});