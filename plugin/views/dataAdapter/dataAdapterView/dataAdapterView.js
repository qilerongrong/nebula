;V.registPlugin("v.views.dataAdapter.dataAdapterView",function(){
	V.Classes.create({
		className:"v.views.dataAdapter.DataAdapterView",
		superClass:"v.views.component.CommonDocket",
		init:function(){
            this.ns = "v.views.dataAdapter.dataAdapterView";
			this.ACTION = {
	...
	})(V.Classes['v.views.dataAdapter.DataAdapterView']);
