V.registPlugin("v.views.component.databaseColumnSelector",function(){
	V.Classes.create({
		className:"v.views.component.DatabaseColumnSelector",
		superClass:"v.views.component.Selector",
		init: function(){
			this.ns = "v.views.component.databaseColumnSelector";
			this.options.fields = [
