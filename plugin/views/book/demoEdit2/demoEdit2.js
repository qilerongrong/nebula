;V.registPlugin("v.views.book.demoEdit2",function(){
	V.Classes.create({
		className:"v.views.book.DemoEdit2",
		superClass:"v.Plugin",
		init:function(){
            this.ns = "v.views.book.demoEdit2";
            this.template = $('<div class="docket2"><div class="con"></div><div class="btns"><a href="javascript:void(0);" class="btn"><i class="icon-add"></i>按钮1</a></a><a href="javascript:void(0);" class="btn back">返回</a></div></div>');
            this.options = {};
		}
	});
	(function(Plugin){
		...
		Plugin.prototype.initEvent = function(){
			...
			//跳转返回
			$('.back',this.template).click(function(){
		...
		Plugin.prototype.forwordExample = function(){
			var options = {};
			this.forword("v.views.book.demoEdit2",options,function(inst){
				inst.addCrumb();
			});
		}
	...
	})(V.Classes['v.views.book.DemoEdit2']);
