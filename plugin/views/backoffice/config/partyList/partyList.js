;V.registPlugin("v.views.backoffice.config.partyList",function() {
	V.Classes.create({
				className : "v.views.backoffice.config.PartyList",
				superClass : "v.views.component.SearchList",
				init : function() {
					this.ns = 'v.views.backoffice.config.partyList';
					this.module = '';
	...
	(function(PartyRegistList) {
		...
		PartyRegistList.prototype.editTicket = function(record){
			...
			this.forward('v.views.backoffice.config.configList',options,function(p){
				p.addCrumb();
			});
		}
	...
	})(V.Classes['v.views.backoffice.config.PartyList']);
}, {
