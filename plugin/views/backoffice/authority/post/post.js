;V.registPlugin("v.views.backoffice.authority.post",function(){
	V.Classes.create({
		className:"v.views.backoffice.authority.Post",
		superClass:"v.Plugin",
		init:function(){
            this.ns = "v.views.backoffice.authority.post";
			this.module = '';
			this.post = null;
	...
	(function(Post){
		...
		Post.prototype.getRoles = function(){
			...
			grid.init({
				...
				url:'backoffice/authority/post/post!roleList.action',
				columns:[
	...
	})(V.Classes['v.views.backoffice.authority.Post'])
});
