;V.registPlugin("v.views.backoffice.authority.roleEdit",function(){
	V.Classes.create({
		className:"v.views.backoffice.authority.RoleEdit",
		superClass:"v.Plugin",
		init:function(){
            this.ns = "v.views.backoffice.authority.roleEdit";
			this.role = null;
		...
		RoleEdit.prototype.initEvent = function(){
			...
			$('.group_edit .cancel',this.template).click(function(){
				if(that.role.id==null){
					...
					//that.forward('v.views.backoffice.authority.roleList',options);
	...
	})(V.Classes['v.views.backoffice.authority.RoleEdit'])
},{plugins:["v.ui.grid","v.ui.pagination","v.ui.dialog","v.ui.tree",'v.ui.alert','v.fn.validator','v.views.component.authoritySetting']});
