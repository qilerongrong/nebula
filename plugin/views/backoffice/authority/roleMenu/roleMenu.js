;V.registPlugin("v.views.backoffice.authority.roleMenu",function(){
	V.Classes.create({
		className:"v.views.backoffice.authority.RoleMenu",
		superClass:"v.Plugin",
		init:function(){
			this.search_result = {};
			this.app_result = {};
			...
			this.module = "";
            this.ns = "v.views.backoffice.authority.roleMenu";
	...
	})(V.Classes['v.views.backoffice.authority.RoleMenu'])
