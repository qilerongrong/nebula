;V.registPlugin("v.views.backoffice.authority.roleList",function(){
	V.Classes.create({
		className:"v.views.backoffice.authority.RoleList",
		superClass:"v.views.component.SearchList",
		init:function(){
            this.ns = "v.views.backoffice.authority.roleList";
            //this.roles = {};
			this.module = '';
	...
	(function(RoleList){
       RoleList.prototype.initConditionForm = function(){
        ...
        RoleList.prototype.editRole = function(role){
			...
			this.forward('v.views.backoffice.authority.roleEdit',this.options,function(p){
				p.addCrumb();
			});
		}
	...
	})(V.Classes['v.views.backoffice.authority.RoleList'])
