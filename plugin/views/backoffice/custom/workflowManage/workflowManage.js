;V.registPlugin("v.views.backoffice.custom.workflowManage",function() {
	V.Classes.create({
				className : "v.views.backoffice.custom.WorkflowManage",
				superClass : "v.views.component.SearchList",
				init : function() {
					this.ns = 'v.views.backoffice.custom.workflowManage';
					this.module = '';
	...
	(function(PartyRegistList) {
		...
		PartyRegistList.prototype.editTicket = function(record){
			...
			this.forward('v.views.backoffice.custom.workflowManage.workflowList',options,function(p){
				p.addCrumb();
			});
		}
	...
	})(V.Classes['v.views.backoffice.custom.WorkflowManage']);
}, {
