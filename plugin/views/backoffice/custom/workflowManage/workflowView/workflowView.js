;V.registPlugin("v.views.backoffice.custom.workflowManage.workflowView",function(){
	V.Classes.create({
		className:"v.views.backoffice.custom.workflowManage.WorkflowView",
		superClass:"v.Plugin",
		init:function(){
            this.ns = 'v.views.backoffice.custom.workflowManage.workflowView';
        	this.module = '';
        	this.workflow = null;
        	this.taskForm = null;
        	this.platformNo = '';
	...
	(function(Task){
		...
		Task.prototype.initHistory = function(){
			...
			list.setFilters({workflowKey:this.workflow.workflowKey,platformNo:this.platformNo});
			list.init({
	...
	})(V.Classes['v.views.backoffice.custom.workflowManage.WorkflowView']);
