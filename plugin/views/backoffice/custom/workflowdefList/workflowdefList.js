;V.registPlugin("v.views.backoffice.custom.workflowdefList",function() {
	V.Classes.create({
				className : "v.views.backoffice.custom.WorkflowdefList",
				superClass : "v.views.component.SearchList",
				init : function() {
					this.ns = 'v.views.backoffice.custom.workflowdefList';
					this.module = '';
	...
	(function(PartyRegistList) {
		...
		PartyRegistList.prototype.editTicket = function(record){
			...
			this.forward('v.views.backoffice.custom.workflowdefList.workflowList',options,function(p){
				p.addCrumb();
			});
		}
	...
	})(V.Classes['v.views.backoffice.custom.WorkflowdefList']);
}, {
