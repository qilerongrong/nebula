;V.registPlugin("v.views.logistics.deliveryQuery.deliveryQueryView",function(){
	V.Classes.create({
		className:"v.views.logistics.deliveryQuery.DeliveryQueryView",
		superClass:"v.views.component.CommonDocket",
		init:function(){
            this.ns = "v.views.logistics.deliveryQuery.deliveryQueryView";
			this.ACTION = {
					INIT:'delivery-query!listDocket.action'
			}
			this.isEdit = false;
		}
	});
	...
	})(V.Classes['v.views.logistics.deliveryQuery.DeliveryQueryView']);
