;V.registPlugin("v.views.logistics.transport.transportView",function(){
	V.Classes.create({
		className:"v.views.logistics.transport.TransportView",
		superClass:"v.views.component.CommonDocket",
		init:function(){
            this.ns = "v.views.logistics.transport.transportView";
			this.ACTION = {
	...
	})(V.Classes['v.views.logistics.transport.TransportView']);
