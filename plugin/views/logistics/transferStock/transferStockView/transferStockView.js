;V.registPlugin("v.views.logistics.transferStock.transferStockView",function(){
	V.Classes.create({
		className:"v.views.logistics.transferStock.TransferStockView",
		superClass:"v.views.component.CommonDocket",
		init:function(){
            this.ns = "v.views.logistics.transferStock.transferStockView";
			this.ACTION = {
	...
	})(V.Classes['v.views.logistics.transferStock.TransferStockView']);
