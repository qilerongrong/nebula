;V.registPlugin("v.views.company.companyView",function(){
	V.Classes.create({
		className:"v.views.company.CompanyView",
		superClass:"v.views.component.CommonDocket",
		init:function(){
            this.ns = "v.views.company.companyView";
			this.ACTION = {
	...
	})(V.Classes['v.views.company.CompanyView']);
