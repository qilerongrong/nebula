    ...
    (function(Page){
        ...
        Page.prototype.initMenu = function(){
            ...
            $.each(menus,function(){
                ...
                ul.append('<li class="nav-header" data-code="'+this.id+'"><i class="icon-menu2 '+this.icon+'"></i><span class="menu_name">'+this.name+'</span></li>');
                ...
                $.each(items,function(){
                    ...
                    $('a',m).data("menu",{'module':module,'menuName':this.name,'menuCode':this.id,'navCode':that.menu.navCode,'plugin':plugin}).click(function(){
