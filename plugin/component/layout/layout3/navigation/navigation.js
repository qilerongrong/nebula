;V.registPlugin("v.component.layout.layout3.navigation",function(){
	V.Classes.create({
		className:"v.component.layout.layout3.Navigation",
		superClass:"v.component.pages.Navigation",
		init:function(){
		    this.ns = "v.component.layout.layout3.navigation";
		}
	});
	(function(Nav){
	...
	})(V.Classes['v.component.layout.layout3.Navigation']);
