;V.registPlugin("v.component.layout.layout3.header",function(){
	V.Classes.create({
		className:"v.component.layout.layout3.Header",
		superClass:"v.component.pages.Header",
		init:function(){
		    this.ns = "v.component.layout.layout3.header";
			this.resource = {
			    html:'template.html'
			}
		}
...
//			})
	...
	})(V.Classes['v.component.layout.layout3.Header']);
