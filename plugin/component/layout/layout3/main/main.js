;V.registPlugin("v.component.layout.layout3.main",function(){
	V.Classes.create({
		className:"v.component.layout.layout3.Main",
		superClass:"v.component.pages.Main",
		init:function(){
		    this.ns = "v.component.layout.layout3.main";
		    this.header = new V.Classes['v.component.layout.layout3.Header']();
		    this.footer = new V.Classes['v.views.pages.Footer']();
		    this.nav = new V.Classes['v.component.layout.layout3.Navigation']();
		    this.page = new V.Classes['v.component.layout.layout3.Page']();
		    this.resource = {
		    	css:'layout3.css'
		    }
		}
...
//				}
	...
	})(V.Classes['v.component.layout.layout3.Main']);
},{plugins:[
            'v.component.layout.layout3.header',
            'v.views.pages.footer',
            'v.component.layout.layout3.page',
            'v.component.layout.layout3.navigation'
            ]});