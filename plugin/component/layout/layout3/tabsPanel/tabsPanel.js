;V.registPlugin("v.component.layout.layout3.tabsPanel",function(){
	V.Classes.create({
		className:"v.component.layout.layout3.TabsPanel",
		superClass:"v.component.pages.TabsPanel",
		init:function(){
            this.ns = 'v.component.layout.layout3.tabsPanel';
            this.maxLength = 8;
		}
	});
	(function(TabsPanel){
	...
	})(V.Classes['v.component.layout.layout3.TabsPanel']);
},{plugins:[]});
