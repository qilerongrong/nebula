;V.registPlugin("v.component.layout.layout2.main",function(){
	V.Classes.create({
		className:"v.component.layout.layout2.Main",
		superClass:"v.component.pages.Main",
		init:function(){
		    this.ns = "v.component.layout.layout2.main";
		    this.header = new V.Classes['v.views.pages.Header']();
		    this.footer = new V.Classes['v.views.pages.Footer']();
		    this.nav = new V.Classes['v.component.layout.layout2.Navigation']();
		    this.page = new V.Classes['v.component.layout.layout2.Page']();
		}
	});
	(function(Layout){
...
//					}
	...
	})(V.Classes['v.component.layout.layout2.Main']);
},{plugins:[
            'v.component.layout.layout2.navigation',
            'v.component.layout.layout2.page'
            ]});