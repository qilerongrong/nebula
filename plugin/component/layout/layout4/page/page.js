;V.registPlugin("v.component.layout.layout4.page",function(){
    V.Classes.create({
        className:"v.component.layout.layout4.Page",
		superClass:"v.Plugin",
        init:function(){
            this.ns = 'v.component.layout.layout4.page';
            this.tabsPanel = null;
			this.menus = [];
			this.menu = null;
            this.options = {
    ...
    (function(Page){
        ...
        Page.prototype.initTabsPanel = function(){
			...
			var p = 'v.component.layout.layout4.tabsPanel';
    ...
    })(V.Classes['v.component.layout.layout4.Page'])
},{plugins:['v.component.layout.layout4.navigation','v.component.layout.layout4.tabsPanel']});