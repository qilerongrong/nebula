;V.registPlugin("v.component.layout.layout4.tabsPanel",function(){
	V.Classes.create({
		className:"v.component.layout.layout4.TabsPanel",
		superClass:"v.component.pages.TabsPanel",
		init:function(){
            this.ns = 'v.component.layout.layout4.tabsPanel';
            this.maxLength = 8;
		}
	});
	(function(TabsPanel){
	...
	})(V.Classes['v.component.layout.layout4.TabsPanel']);
},{plugins:[]});
