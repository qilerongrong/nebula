;V.registPlugin("v.module.authority.postControlPoint",function(){
    V.Classes.create({
        className:"v.module.authority.PostControlPoint",
        superClass:"v.Plugin",
        init:function(){
            this.template = $('<div></div>');
            this.module = "";
            this.ns = "v.module.authority.postControlPoint";
    ...
    })(V.Classes['v.module.authority.PostControlPoint'])
