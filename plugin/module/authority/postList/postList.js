;V.registPlugin("v.module.authority.postList",function(){
	V.Classes.create({
		className:"v.module.authority.PostList",
		superClass:"v.component.SearchList",
		init:function(){
            this.ns = "v.module.authority.postList";
            //this.posts = {};
			this.module = '';
...
//			this.subscribe(list,'createJson',this.createJsonData);
        ...
        PostList.prototype.editPost = function(post){
			...
			this.options.module = this.module;
	   		this.forward('v.module.authority.postEdit',this.options,function(p){
				p.addCrumb();
			});
		}
...
//			this.options.module = 'backoffice/authority/role';
			this.forward('v.module.authority.roleEdit',opts,function(p){
				p.addCrumb();
			});
		}
	...
	})(V.Classes['v.module.authority.PostList'])
