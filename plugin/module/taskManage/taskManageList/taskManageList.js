 ...
 */
;
V.registPlugin("v.module.taskManage.taskManageList", function(){
    V.Classes.create({
        className: "v.module.taskManage.TaskManageList",
        superClass: "v.component.SearchList",
        init: function(){
            this.ns = 'v.module.taskManage.taskManageList';
            this.module = '';
			this.partner = '';
    ...
    (function(TaskManageList){
        ...
        TaskManageList.prototype.initList = function(){
            ...
            list.setFilters({triggerType:'CUSTOM'});
			var toolbar = [];
...
// 				toolbar.push({
//                    eventId: 'addapt',
//                    text: GatewayLang.Schedule.New_adapter_task,
//                    icon: 'icon-business-link'
//                }); 
				toolbar.push( {
                    eventId: 'add',
                    text: GatewayLang.Schedule.Add_a_custom_task,
                    icon: 'icon-cust-task'
                });
			}
            var that = this;
            list.init({
                ...
                checkable: false,
                url: "quartzJson/jquartzs!list.action",
                columns: [{
...
//                            return V.Util.formatFullDate(new Date(record.lastStartTime));
//                        }
//                    }
                }, {
                    ...
                    width: 40
//                    render: function(record){
//                        if (record.lastEndTime != null) {
//                            return V.Util.formatFullDate(new Date(record.lastEndTime));
//                        }
//                    }
                }, {
                    ...
                    render: function(record){
                        if (record.type == 0) {
                            return GatewayLang.Schedule.Adapter_task;
                        }
                        else 
                            if (record.type == 1) {
                                return GatewayLang.Schedule.Custom_task;
                            }
                    }
                }, {
...
//                            }
        ...
        TaskManageList.prototype.addEditAptTask = function(record){
            ...
            addDlg.init({
                title: GatewayLang.Schedule.New_adapter_task,
                height: 550,
                width: 760
            });
            /** 将Grid中的数据加入到Dialog中* */
		...
		TaskManageList.prototype.saveTaskInfo = function(addDlg,record){
			...
			trigger['triggerDesc'] = $("textarea[name=triggerDesc]", addDlg.template).val();
        ...
        TaskManageList.prototype.initAptData = function(d, trigger){
            ...
            $("textarea[name=triggerDesc]", d).val(trigger['triggerDesc'] || '');
...
//            });
        ...
        TaskManageList.prototype.addEditTask = function(record){
            ...
            addDlg.init({
                title: GatewayLang.Schedule.Add_a_custom_task,
                height: 550,
                width: 790
            });
            /** 将Grid中的数据加入到Dialog中* */
    ...
    })(V.Classes['v.module.taskManage.TaskManageList']);
}, {
