;V.registPlugin("v.module.report.reportManage.templateEditList",function(){
	V.Classes.create({
		className:"v.module.report.reportManage.TemplateEditList",
		superClass:"v.component.SearchList",
		init:function(){
            this.ns = 'v.module.report.reportManage.templateEditList';
        	this.module = '';
	...
	(function(ReportEditList){
		ReportEditList.prototype.initConditionForm = function(){
			...
			var items = [
		       {label:"模板标题",type:Form.TYPE.TEXT,name:'reportTitle',value:''}
//		       ,{label:this.getLang("LABEL_REPORT_TYPE"),type:Form.TYPE.TEXT,name:'reportType',value:''}
		...
		ReportEditList.prototype.initList = function(){
			...
			list.init({
				...
				checkable : false,
				url : this.module + '/report!templateList.action',
				columns : [
					{
						displayName : "模板标题",
						key : 'reportTitle',
...
//						}
				...
				toolbar:[
				    {eventId:'add',text:"新增模板",icon:'icon-plus'}
				]
			});
	...
	})(V.Classes['v.module.report.reportManage.TemplateEditList']);
